...
\abstract{Evolution is often viewed as a fundamental characteristic of life, involving replicating entities capable of adaptation and governed by fitness-driven selection. In this paper, we explore a weaker form of abiotic evolution, demonstrating how randomness, feedback loops, and population dynamics can drive the emergence of stable, ordered patterns without reliance on specific physical laws. Through abstract, non-physical systems of symbolic tokens governed by local probabilistic interactions and fitness-based selection, we illustrate how imbalances in frequency and fitness create feedback loops that produce emergent complexity. Emergent patterns in complex systems often arise from simple rules governing interactions between elements. In this paper, we develop a theoretical framework where feedback mechanisms reinforce stable patterns, leading to emergent structures with long-term persistence. Using simulations of symbolic populations subject to probabilistic interactions and resource constraints, we show how frequency dynamics, regeneration rates, and stability biases create hierarchical order. We discuss how these mechanisms connect Bayesian reasoning, where frequency updates reflect environmental feedback, with the interplay of top-down and bottom-up causality. Our findings provide insights into the principles of pattern formation across biological, chemical, and abstract systems. This study highlights that emergent complexity is a universal property of systems with probabilistic interactions and selection mechanisms, offering a new perspective on the origins of pattern formation beyond the constraints of physical determinism.}
