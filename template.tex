...
\abstract{Evolution is often viewed as a fundamental characteristic of life, involving replicating entities capable of adaptation and governed by fitness-driven selection. In this paper, we explore a weaker form of abiotic evolution, demonstrating how randomness, feedback loops, and population dynamics can drive the emergence of stable, ordered patterns without reliance on specific physical laws. Through abstract, non-physical systems of symbolic tokens governed by local probabilistic interactions and fitness-based selection, we illustrate how imbalances in frequency and fitness create feedback loops that produce emergent complexity. This study highlights that emergent complexity is a universal property of systems with probabilistic interactions and selection mechanisms, offering a new perspective on the origins of pattern formation beyond the constraints of physical determinism.}
