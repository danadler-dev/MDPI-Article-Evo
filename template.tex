...
In ABC systems, the \textit{stability} distribution determines which patterns persist and thus influence subsequent interactions. We define stability as a product of three factors: longevity, interactivity, and environmental conditions:
